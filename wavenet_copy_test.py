...
class ResidualBlock(nn.Module):
    ...
    def forward(self, x, conditioner, diffusion_step):
        """
        x: 输入张量，形状为 [batch_size, residual_channels, seq_len]。
        conditioner: 条件输入，形状为 [batch_size, encoder_hidden, seq_len]。
        diffusion_step: 当前扩散步长，形状为 [batch_size, residual_channels]。
        """
        # x：[48,512,187]
